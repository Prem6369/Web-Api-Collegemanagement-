...
namespace Collegemanagement.Repository.Base
{
        ...
        public class RepositoryBase : IRepository
        {
            ...
            protected async Task ExecuteSP(string spName, Action<SqlParameterCollection> parameterize = null, IDataMapper dataMapper = null, Action<SqlParameterCollection> onCompleted = null, ConnectionStringType connectionStringType = ConnectionStringType.TaskTrackerBusiness)
            {
